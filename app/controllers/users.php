...
//If user has clicked the register button or add user button
if (isset($_POST['register-btn']) || isset($_POST['create-admin'])) {
  ...
  if(count($errors) === 0){
    ...
    //Password encryption by using password_hash function provided by php
    $_POST['password'] = password_hash($_POST['password'], PASSWORD_DEFAULT);

    if (isset($_POST['admin'])) {
      $_POST['admin'] = 1; // 1 is true. i.e. is admin
